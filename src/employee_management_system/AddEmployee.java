...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee() {
        ...
        tfname.setFont(new Font("Tahome",Font.PLAIN,15));
        ...
        dcdob.setFont(new Font("Tahoma",Font.PLAIN,15));
       dcdob.setForeground(Color.blue);
        ...
        tfsalary.setForeground(Color.blue);
        ...
        cbeducation.setForeground(Color.blue);
        add(cbeducation);
        ...
        tfaadhar.setFont(new Font("Tahoma",Font.PLAIN,15));
        tfaadhar.setForeground(Color.blue);
        add(tfaadhar);
